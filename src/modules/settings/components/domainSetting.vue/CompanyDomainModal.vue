                        ...
                        <DialogPanel
                                ...
                                <div class="mt-3 sm:mt-5">
                                    ...
                                    <div class="mt-5">
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            ...
                                            <span
                                                class="inline-flex items-center rounded-r-md border border-l-0 border-gray-300 bg-gray-50 px-3 text-gray-500 sm:text-sm">{{  companyDomain && companyDomain.id ? companyDomain.tenant_domain : 'domain.test' }}</span>
                            ...
                            <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                <button type="button"
                                    ...
                                    @click="saveDomain()">{{ loadingSave ? 'Saving...' : 'Save'}}</button>
                                <button type="button"
...
const saveDomain = async () => {
    ...
    companyProfile.value.domain = domain.value.name
